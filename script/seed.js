...
async function seed() {
  ...
  const users = await Promise.all([
    User.create({ username: 'cody', password: '123', email: 'cody@gmail.com', isAdmin: false, favorites: [], createdRecipes: [] }),
    User.create({ username: 'murphy', password: '123', email: 'murphy@gmail.com', isAdmin: false, favorites: [], createdRecipes: [] }),
    User.create({ username: 'admin', password: '123', email: 'admin@gmail.com', isAdmin: true, favorites: [], createdRecipes: [] }),
  ])
